            ...
            <div className="iot-services-area pt-80 pb-50">
                <div className="container justify-content-center">
                    <div className="section-title">
                        <h2 className="mb-4">Empower Your Business with Scalable and Innovative Web Solutions.</h2>
                        <p className="mb-4">
                            Our experienced and highly skilled developers excel in providing a
                            comprehensive array of web development services. Here are some
                            of the tailored solutions we can offer to meet your specific needs.
                        </p>
                    </div>
                    ...
                    <div className="row justify-content-center">
                        ...
                        >
                            <div className="single-repair-services">
                                ...
                                <p >
                                    KarmaLeen specializes in front-end web development,
                                    crafting visually stunning and fully responsive interfaces
                                    that ensure a smooth user experience. We bring your ideas
                                    to life with modern design and cutting-edge functionality,
                                    creating dynamic websites that captivate and engage.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <p>
                                    KarmaLeen specializes in back-end web development, designing robust and scalable
                                    architectures that drive your website’s core functionality. Our secure, high-performance solutions ensure seamless data management,
                                    efficient user interactions, and a smooth, reliable experience for your audience.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <p>
                                    At KarmaLeen, we specialize in SaaS web development, creating scalable,
                                    high-performance cloud-based applications tailored to your business needs.
                                    Our expert team designs secure, user-friendly platforms with seamless integrations and robust backend architectures.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <p>
                                    KarmaLeen specializes in eCommerce web app development,
                                    building high-performance, user-friendly online stores that boost sales and elevate customer experiences.
                                    Our secure, scalable solutions are tailored to your business needs, ensuring seamless transactions, intuitive navigation, and a frictionless shopping journey.
                                </p>
                        ...
                        >
                            ...
                            >
                                ...
                                <p>
                                    KarmaLeen excels in custom web app development,
                                    delivering tailored solutions that align perfectly
                                    with your business objectives.We create innovative,
                                    scalable applications that enhance functionality and provide a seamless user experience,
                                    ensuring your digital platform stands out in a competitive market.
                                </p>
                        ...
                        >
                            ...
                            >
                                ...
                                <p>
                                    At KarmaLeen, we specialize in Progressive Web App (PWA) development,
                                    creating fast, reliable, and engaging web applications that deliver a native app-like experience.
                                    Our PWAs are optimized for performance, offline functionality,
                                    and cross-platform accessibility, ensuring seamless user interactions and increased engagement for your business.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <p>
                                    At KarmaLeen, we offer Chrome Extension Development,
                                    building powerful, lightweight, and feature-rich extensions
                                    tailored to enhance productivity and user experience.
                                    Whether you need automation tools, integrations,
                                    or custom browser functionalities, our expert team delivers secure,
                                    high-performance solutions that seamlessly extend your web capabilities.
                                </p>
                            </div>
                        </div> */}
                    </div>
